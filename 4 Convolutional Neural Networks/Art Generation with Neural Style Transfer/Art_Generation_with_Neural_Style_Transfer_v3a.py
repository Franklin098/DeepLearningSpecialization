...
def compute_content_cost(a_C, a_G):
    ...
    #  tf.reshape(a_C,[m,-1,n_C]) = tf.reshape(a_C, [m,n_H*n_W,n_C])
...
content_image = scipy.misc.imread("images/antigua.jpg")
...
style_image = scipy.misc.imread("images/noche_estrellada.jpg")
